...
// return -1 when error
int socket_server_send(struct socket_server *, int id, const char * buffer, int sz);
...
int socket_server_udp_send(struct socket_server *, int id, const struct socket_udp_address *, const char *buffer, int sz);
